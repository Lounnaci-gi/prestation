      ...
      <Card title="Paramètres Généraux">
        <div className="settings-grid">
          <div className="setting-item">
            <label htmlFor="entreprise" className="setting-label">Nom de l'entreprise</label>
            <input 
              type="text" 
              id="entreprise" 
              className="setting-input" 
              defaultValue="Gestion Eau" 
              placeholder="Nom de votre entreprise"
            />
          </div>
          
          <div className="setting-item">
            <label htmlFor="devise" className="setting-label">Devise par défaut</label>
            <select id="devise" className="setting-input">
          ...
          <div className="setting-item">
            <label htmlFor="langue" className="setting-label">Langue</label>
            <select id="langue" className="setting-input">
